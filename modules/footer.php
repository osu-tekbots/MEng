...
?>
<button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#faqModal" style="position: fixed; left: 20px; bottom: 20px; z-index: 1001; background: rgb(195, 69, 0); color: #fff; font-size: 1rem; padding: .375rem .75rem; border-radius: 0.25rem; font-weight: normal;">
